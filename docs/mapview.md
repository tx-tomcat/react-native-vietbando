...
| `customMapStyle` | `Array` |  | Adds custom styling to the map component. See [README](https://github.com/dzungdinh94/react-native-vietbando#customizing-the-map-style) for more information.
