...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/dzungdinh94/react-native-vietbando#readme"
  s.license      = "MIT"
  s.platform     = :ios, "8.0"

  s.source       = { :git => "https://github.com/dzungdinh94/react-native-vietbando.git", :tag=> "v#{s.version}" }
